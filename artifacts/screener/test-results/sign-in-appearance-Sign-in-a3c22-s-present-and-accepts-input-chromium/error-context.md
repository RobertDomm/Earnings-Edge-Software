...
- Name: sign-in-appearance.spec.ts >> Sign-in page — sign-in flow still works >> email input is present and accepts input
- Location: e2e/sign-in-appearance.spec.ts:84:3

# Error details

```
Error: page.waitForSelector: Page crashed
Call log:
